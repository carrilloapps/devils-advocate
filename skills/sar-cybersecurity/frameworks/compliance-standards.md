...
>
> Load this framework when the assessment requires mapping findings to compliance standards or when the target system operates under regulatory requirements (PCI-DSS, HIPAA, GDPR, SOX, FedRAMP, etc.).
...
- **CIS Controls**: A prioritized guide of defensive actions (formerly known as SANS Top 20) to protect against the most common cyberattacks.
